%% 3D PK-PD Surface with Raw Data Overlay - Daunorubicin O2
...
RAW_DATA_PATH = fullfile(PROJECT_ROOT, 'Cleaned_Data', 'O2_Mean_Averaged.xlsx');
...
% O2 columns have '_1' suffix in MATLAB (from '.1' in Excel)
...
if REMOVE_R0_OFFSET
    zlabel('O_2 Response (R_0 removed)', 'FontSize', 11);
else
    zlabel('O_2 Response (%)', 'FontSize', 11);
end

title(sprintf('%s - O_2', DRUG_NAME), 'FontSize', 13, 'FontWeight', 'bold');
